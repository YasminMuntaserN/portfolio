import CodeSkill from "./CodeSkill";
      ...
      <div className="card-skills object-card">
        ...
        <code>
          ...
          <div className="m-l-20">
            ...
            <span className="text-gray">[</span>
              {skills.slice(0, 5).map((skill, index) =>(<CodeSkill name={skill} index={index} key={index}/>))}
            <span className="text-gray">]</span>
          </div>
          <div className="m-l-20">
            <span className="text-white">tools:</span>
            <span className="text-gray">[</span>
              {tools.slice(0, 5).map((tool, index) =>(<CodeSkill name={tool} index={index} key={index}/>))}
            <span className="text-gray">]</span>
          </div>
          <div className="m-l-20">
